...
import static com.example.gymtest.TrainingActivity.TRAINING_KEY;
        ...
        if(type.equals("edit")){
            holder.emptyCircle.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(context)
                            .setTitle("Beenden ?")
                            .setMessage("Hast du " + plans.get(position).getTraining().getName() + " beendet?")
            ...
            holder.parent.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(context)
                            .setTitle("Entfernen ?")
                            .setMessage("Bist du sicher, das du den Plan: " + plans.get(position).getTraining().getName() + "" + " von deinen Plänen löschen willst?")
                            .setNegativeButton("Nein", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
